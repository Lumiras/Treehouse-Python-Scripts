"""Dungeon Game
explore a dungeon to find a hidden door and escape. But, be careful, the monster is looking for you!
...
def build_cells(width, height):
    """Create and return a width by height grid of 2 tuples
...
def get_moves(player):
    """based on tuple of player's position, return list of acceptable moves
